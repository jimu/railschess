...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post pieces_url, params: { piece: { game_id: @piece.game_id, name: @piece.name, player_id: @piece.player_id, position: @piece.position } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { game_id: @piece.game_id, name: @piece.name, player_id: @piece.player_id, position: @piece.position } }
