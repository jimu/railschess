...
class MovesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post moves_url, params: { move: { game_id: @move.game_id, orders: @move.orders, player_id: @move.player_id, turn: @move.turn } }
    end
  ...
  test "should update move" do
    patch move_url(@move), params: { move: { game_id: @move.game_id, orders: @move.orders, player_id: @move.player_id, turn: @move.turn } }
